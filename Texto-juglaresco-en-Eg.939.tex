...
\end{center}
\pstart
Y los siervos bien \emph{abiertos}\footnoteE{\emph{Y los siervos bien midridos} / \emph{traygan sienpre los sentidos} = el vocablo adjetivo «midridos» parece provenir del vocablo griego \emph{μυδρίασις}, que significa «dilatación de la pupila» (\href{https://logeion.uchicago.edu/\%CE\%BC\%CF\%85\%CE\%B4\%CF\%81\%CE\%AF\%CE\%B1\%CF\%83\%CE\%B9\%CF\%82}{\textbf{μυδρίασις}}); de ser así la etimología para el adjetivo utilizado, el sentido sería, entonces, que los siervos deberían traer «los sentidos bien abiertos» o «estar muy atentos».}\\
