...
%
\newcommand{\centre}[1]{{\centering \textbf{#1}\par}}
%
\begin{document}
%
...
\newpage
%
\subsection*{\centering\textsc{Agora es tienpo de ganar buena soldada}}
%
...
co\emph{n} fervor de co\emph{n}triçió\emph{n}\footE{Esto significa «orar con arrepentimiento».},\\
...
Ih\emph{e}su Chr\emph{is}to\footE{Emula la nomina sacra corriente durante el medioevo, cuya utilización se atestigua en los antiguos
...
q\emph{ue} por dios nos fue ganada\footE[4]{¿Es plausible considerar que el cabo o estrofa de cierre sea un añadido del copista por cuenta propia o por orden ajena? Probablemente lo sea porque el encabezamiento anuncia que es un cantar \emph{que dizen los juglares} y, por tanto, pertenecería a la tradición oral y no escrita y, de ser la \emph{enmendatio} «l\suppl{ea}» --realizada por \textcite{Severin2000}-- la lección correcta, la estrofa que cierra el texto estaría falseando la propia oralidad intrínseca a la tradición juglaresca, al enviar o invitar a leer y no a oír o «atender» lo que se recita.}.\par
\poend
\enum
\repage
%
\subsection*{\centering\textsc{Ahora es tiempo de ganar buena soldada}}
%
Para los devotos cristianos que están en la batalla espiritual se aplican estos metros de la canción que llaman los juglares: «\emph{ahora es tiempo de ganar buena soldada}»\footE[1]{«soldada» = de sueldo, recibir un pago por las acciones o un trabajo. El texto apunta a que el «pago» a recibir es el «reino divino», prometido a quienes sigan al Cristo.}.\par
%
\bnum
\begin{center}
\textbf{I}
...
\end{center}
\postart
Y los siervos bien \emph{abiertos}\footE[2]{\emph{Y los siervos bien midridos} / \emph{traygan sienpre los sentidos} = el vocablo adjetivo «midridos» parece provenir del vocablo griego \emph{μυδρίασις}, que significa «dilatación de la pupila» (\href{https://logeion.uchicago.edu/\%CE\%BC\%CF\%85\%CE\%B4\%CF\%81\%CE\%AF\%CE\%B1\%CF\%83\%CE\%B9\%CF\%82}{\underline{μυδρίασις}}); de ser así la etimología para el adjetivo utilizado, el sentido sería, entonces, que los siervos deberían traer «los sentidos bien abiertos» o «estar muy atentos».}\\
...
ya no los \emph{tendrás}\footE[3]{«ternas» en el \emph{cod.} Proviene de «ternir», un arcaísmo castellano que significa «tener». En este caso el significado del vocablo es «tendrás» (\emph{seg. sg. fut.}). Lo atestigua el manuscrito \textit{M} del \emph{Libro de los doze sabios}, ubicado en la Biblioteca Menéndez Pelayo de Santander. <\url{https://parnaseo.uv.es/Memorabilia/Memorabilia6/listillos/menu.htm}>. Para la significación \emph{cfr.} <\url{https://historicas.unam.mx/publicaciones/publicadigital/monarquia/volumen/07/miv7042.pdf}>} en nada.\par
\poend
%
\begin{center}
\textbf{XIII}
\end{center}
\postart
Do \emph{vendrás}\footE[4]{«vernas» en el \emph{cod.} Es un arcaísmo castellano de «venir», que significa «vendrás» (\emph{seg. sg. fut.}). Atestigua este vocablo el manuscrito de la \emph{Fazienda de Ultramar} (Univ. de Salamanca), año 1220-1230.
...
\repage
%
\section*{\centering\textsc{Imágenes del códice}}
%
{\centering
